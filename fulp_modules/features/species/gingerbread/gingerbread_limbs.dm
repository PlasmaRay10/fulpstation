...
/obj/item/bodypart/head/gingerbread
	icon = 'fulp_modules/icons/species/mob/gingerbread.dmi'
	icon_state = "gingerbread_head"
	icon_static = 'fulp_modules/icons/species/mob/gingerbread.dmi'
...
/obj/item/bodypart/head/gingerbread/Initialize(mapload)
	...
	initial_reagents = list(/datum/reagent/consumable/nutriment = 25, /datum/reagent/consumable/nutriment/vitamin = 7, /datum/reagent/consumable/sugar = 5), \
	foodtypes = GRAIN | SUGAR | DAIRY, \
	volume = 60, \
	eat_time = 3 SECONDS, \
	tastes = list("gingerbread" = 5, "sugar" = 3, "hope" = 1), \
...
/obj/item/bodypart/chest/gingerbread/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/edible, \
...
/obj/item/bodypart/arm/left/gingerbread/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/edible, \
	initial_reagents = list(/datum/reagent/consumable/nutriment = 25, /datum/reagent/consumable/nutriment/vitamin = 7, /datum/reagent/consumable/sugar = 5), \
	foodtypes = GRAIN | SUGAR | DAIRY, \
...
/obj/item/bodypart/arm/right/gingerbread/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/edible, \
	initial_reagents = list(/datum/reagent/consumable/nutriment = 25, /datum/reagent/consumable/nutriment/vitamin = 7, /datum/reagent/consumable/sugar = 5), \
	foodtypes = GRAIN | SUGAR | DAIRY, \
...
/obj/item/bodypart/leg/right/gingerbread/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/edible, \
	initial_reagents = list(/datum/reagent/consumable/nutriment = 25, /datum/reagent/consumable/nutriment/vitamin = 7, /datum/reagent/consumable/sugar = 5), \
	foodtypes = GRAIN | SUGAR | DAIRY, \
